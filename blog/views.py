        ...
        try:
            ...
            for article in all_articles:
                data.append({
                    ...
                    "cover2": article.cover2.url if article.cover2 else None,
                    "cover3": article.cover3.url if article.cover3 else None,
                    "price": article.price,
        ...
        try:
            ...
            for article in articles:
                data.append({
                    "title": article.title,
                    "cover": article.cover.url if article.cover else None,
                    "cover2": article.cover2.url if article.cover else None,
                    "cover3": article.cover3.url if article.cover else None,
                    "price": article.price,
                    "content": article.content,
                    "created_at": article.created_at,
                    "category": article.category.title,
    ...
    def post(self, request, format=None):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                cover2 = request.FILES['cover2']
                cover3 = request.FILES['cover3']
            ...
            article.title = title
            article.cover = cover
            article.cover2 = cover2
            article.cover3 = cover3
            article.price = price
...
class UpdateArticleAPIView(APIView):
    ...
    def post(self, request, format=None):
        try:
            ...
            Article.objects.filter(id=article_id).update(cover2=cover2)
            Article.objects.filter(id=article_id).update(cover3=cover3)
